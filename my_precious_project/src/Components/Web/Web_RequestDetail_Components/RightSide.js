...
function RightSide({ under100, updateLeftSide, setUpdateLeftSide, boardId }) {
  ...
  useEffect(() => {
    axios
      .get(
        `https://moneyglove.site:8080/api/v23/debts/boards/${boardId.board_id}`
      )
      .then((response) => {
  ...
  const handleBurrowConfirmation = (event) => {
    if (uid) {
      ...
      setLinkto(!linkTo);
      setGetboardid(boardId.board_id);
      navigate("/Login");
    }
  };
  console.log(uid);
            ...
            <GuideMessage>
              ...
              <ImageRowDiv>
                <ImageColumnDiv>
                  ...
                  <TextDiv>
                    <GraySmallText>이메일로</GraySmallText>{" "}
                    <OrangeSmallText>대신 리마인드</OrangeSmallText>
                  </TextDiv>
                  <TextDiv>
                ...
                <ImageColumnDiv>
                  ...
                  <TextDiv>
                    <OrangeSmallText>차용증의 역할</OrangeSmallText>
                    <GraySmallText>을 해줘요.</GraySmallText>
                  </TextDiv>
                </ImageColumnDiv>

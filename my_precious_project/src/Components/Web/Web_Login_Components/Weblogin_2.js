            ...
            >
              <Label1 isButtonClicked={isButtonClicked}>
                ...
                <button
                  ...
                  disabled={isButtonClicked}
                  style={{
                    backgroundColor: isButtonClicked ? "#D9D9D9" : "#ff3d00",
                  }}
                >
                  인증번호 받기
                </button>
...
const Label1 = styled.label`
  ...
  input {
    ...
    border: ${(props) =>
      props.isButtonClicked
        ? "0.09375rem solid #D9D9D9"
        : "0.09375rem solid #ff3d00"};
  ...
  button {
    ...
    background-color: ${(props) =>
      props.isButtonClicked ? "#D9D9D9" : "#ff3d00"};
    cursor: pointer;
  }
`;
...
const Label2 = styled.label`
  ...
  button {
    ...
    font-weight: 500;
    background-color: ${(props) =>
      props.isButtonClicked ? "#ff3d00" : "#D9D9D9"};
    cursor: pointer;
  }
`;
